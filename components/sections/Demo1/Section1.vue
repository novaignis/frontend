            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-6">
                    <div class="hero-5-txt wow fadeInRight">
                        <!-- Title -->
                        <h2 class="s-58 w-700">Nova Ignis: Enciende Tu Éxito Digital</h2>
                        <!-- Text -->
                        <p class="p-lg">Conviértete en líder del mercado con nuestra solución integral de marketing digital. En Nova Ignis, prometemos transformar tu visión en resultados palpables.</p>
                        <!-- Button -->
                        <a href="#banner-7" class="btn r-04 btn--theme hover--theme">Habla con un agente</a>
                    </div>
                </div>
                <!-- END HERO TEXT -->
                <!-- HERO IMAGE -->
