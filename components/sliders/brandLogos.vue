<template>
    <div class="brands-carousel-5">
        ...
        >
            ...
            <SwiperSlide>
                <div class="brand-logo">
                    <img class="img-fluid theme-light" src="/assets/images/brand-10.png" alt="brand-logo" />
                    <img class="img-fluid theme-dark" src="/assets/images/brand-10-white.png" alt="brand-logo" />
                </div>
            </SwiperSlide>
